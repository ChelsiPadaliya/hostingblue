    ...
    const fetchData = async () => {
      try {
        ...
        if (plansData.success) {
          const dedicatedPlans = plansData.data
            .filter((plan: HostingPlan) =>
              plan.sectionData.hostingplan.type.some(
                (type) => type.toLowerCase().trim() === "dedicated"
              )
            )
            .sort(
  ...
  return (
    <>
      <section className="pricing-section -mt-[100px] pb-70">
        <div className="container">
          <div className="section-title section-title-two">
            <h2>Dedicated Hosting Plans</h2>
            <p>
              Choose the perfect dedicated hosting plan for your needs with scalable
          ...
          {plans.length > 0 ? (
            ...
            <div className="text-center py-5">
              <h5>No Dedicated Hosting Plans Available</h5>
            </div>
          )}
        </div>
      </section>
      ...
      {features.length > 0 ? (
        <section className="feature-section bg-off-white-gradient pt-40 pb-70">
          <div className="container">
            <div className="section-title section-title-two">
              ...
              <h2>Dedicated Hosting Features</h2>
              <p>
                Discover the powerful features included with your dedicated hosting
              </p>
            </div>
        ...
        <section className="feature-section bg-off-white-gradient pt-40 pb-70">
          <div className="container">
            <div className="section-title section-title-two">
              <small>Features</small>
              <h2>Dedicates Hosting Features</h2>
              <p>
                Discover the powerful features included with your dedicated hosting
              </p>
            </div>
            <div className="text-center">
              <h5>No Dedicated Hosting Features Available</h5>
            </div>
          </div>
        </section>
      )}
