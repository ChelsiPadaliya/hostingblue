...
const HOSTING_CATEGORIES = [
  ...
  { value: "cloud", label: "Cloud Hosting", types: ["Cloud"] },
  { value: "dedicated", label: "Dedicated Hosting", types: ["Dedicated"] },
...
const HostingPageContent = () => {
  ...
  const [selectedTypes, setSelectedTypes] = useState<string[]>(["Cloud"]);
  ...
  useEffect(() => {
    ...
    if (categoryParam) {
      const category = HOSTING_CATEGORIES.find(
    ...
    <>
      <section className="pricing-section -mt-[100px] pb-70">
        <div className="container">
          <div className="section-title section-title-two">
            <h2>
              {HOSTING_CATEGORIES.find((cat) => cat.value === selectedCategory)
                ?.label || "Hosting"}{" "}
              Plans
            </h2>
            <p>
              Choose the perfect hosting plan for your needs with scalable
        ...
        <section className="feature-section bg-off-white-gradient pt-40 pb-70">
          <div className="container">
            <div className="section-title section-title-two">
              ...
              <p>
                Discover the powerful features included with your hosting plan
              </p>
            </div>
        ...
        <section className="feature-section bg-off-white-gradient pt-40 pb-70">
          <div className="container">
            ...
            <div className="text-center">
              <h5>No hosting features available for selected types</h5>
            </div>
          </div>
        </section>
      )}
